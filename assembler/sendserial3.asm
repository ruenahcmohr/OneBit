...
;
;
; read inputPort and send the value in serial as an ASCII character to TxDPort with linefeed.
...
START:
 ...
 OUTV TxDPort 0 ; start bit
 NOP            ; data bit 0
 OUTV TxDPort 1 ; data bit 1
 OUTV TxDPort 0 ; data bit 2
 OUTV TxDPort 1 ; data bit 3
 OUTV TxDPort 0 ; data bit 4
 NOP            ; data bit 5
 NOP            ; data bit 6
 NOP            ; data bit 7
 OUTV TxDPort 1 ; stop bit
